@MCI09 @Regression
Feature: MCI09_ValidateBookedServicesInShoppingCart
  Description: Verify Mobile Check-In function work properly after appointment is booked by Appointment Manager

  Scenario Outline: Verify that services selected during appointment creation are displayed on shopping cart
    ...
    And I click "SHOPPING CART" button on 'HOME' page    
	  And I validate captured services on Shopping Cart 'HOME' page
