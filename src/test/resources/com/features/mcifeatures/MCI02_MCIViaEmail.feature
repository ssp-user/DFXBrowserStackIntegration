@MCI02 @Regression
Feature: MCI02_MCIViaEmail
  Description: Verify Mobile Check-In function work properly after appointment is booked by Appointment Manager

  Scenario Outline: Verify Mobile Check-In function work properly after appointment is booked by Appointment Manager and customer checked in through Email
    ...
    And I set promise time "3th" available timeslot on 'TIME & ADVISOR' page
    ...
    Examples: below data set for data driven
      ...
      | VINGENERATOR | TEST2ALAUDI | Dummy | Anytown USA Automall |              1 |    35001 | YAHOO |
