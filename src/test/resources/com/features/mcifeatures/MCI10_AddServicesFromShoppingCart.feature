@MCI10 @Regression
Feature: MCI10_AddServicesFromShoppingCart
  Description: Verify Mobile Check-In function work properly after appointment is booked by Appointment Manager

  Scenario Outline: Verify that user is able to add additional services from shopping cart
    ...
    And I click "SHOPPING CART" button on 'HOME' page        
    And I click "ADD MORE SERVICES" button on 'HOME' page  
    And I add recommended services from cart on 'HOME' page
    And I scroll to the bottom of the 'HOME' page
    And I click "NEXT" button on 'HOME' page     
    ...
    Examples: below data set for data driven
      ...
      | VINGENERATOR | TEST2ALAUDI | Dummy | Anytown USA Automall |              1 |    35001 | TEST2MCIAUDI |
