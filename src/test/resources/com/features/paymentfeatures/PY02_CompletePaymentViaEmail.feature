@PY02 @Regression
Feature: PY02_CompletePaymentViaEmail
  Description: Create Invoice. Complete Payment Via Email and Validate payment status.

  Scenario Outline: Create Invoice. Complete Payment Via Email and Validate payment status.
