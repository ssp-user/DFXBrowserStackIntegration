...
Feature: CD03 - Push RO and search it on communication dashboard
  ...
  Scenario Outline: Advisor Check Able to DMS Push RO by VIN decode for <DMS>
    ...
    And I click "Other messages" on 'Communication Dashboard' window
    ...
    Examples: below data set for data driven
      ...
      | TEST2DFX | Dummy | anytown usa automall | 408A85US   |    50010 | TagDm     | WAUTPBFF3GA050764 |       1 | 2.9.19035.01     | CHECK-IN    |
